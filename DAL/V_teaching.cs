...
namespace ITCastOCSS.DAL
{
    ...
    public partial class v_Teaching
    {
        ...
        public bool Exists(int SID, string SNo, string SName, int CID, int Credit, string CName, string Week, string Timeperiod, string Place, int MaxNum, int ActualNum, decimal Score, int TID)
        {
            ...
            strSql.Append("select count(1) from v_Teaching");
            strSql.Append(" where SID=@SID and SNo=@SNo and SName=@SName and CID=@CID and Credit=@Credit and CName=@CName and Week=@Week and Timeperiod=@Timeperiod and Place=@Place and MaxNum=@MaxNum and ActualNum=@ActualNum and Score=@Score and TID=@TID ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into v_Teaching(");
            strSql.Append("SID,SNo,SName,CID,Credit,CName,Week,Timeperiod,Place,MaxNum,ActualNum,Score,TID)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update v_Teaching set ");
        ...
        public bool Delete(int SID, string SNo, string SName, int CID, int Credit, string CName, string Week, string Timeperiod, string Place, int MaxNum, int ActualNum, decimal Score, int TID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from v_Teaching ");
            strSql.Append(" where SID=@SID and SNo=@SNo and SName=@SName and CID=@CID and Credit=@Credit and CName=@CName and Week=@Week and Timeperiod=@Timeperiod and Place=@Place and MaxNum=@MaxNum and ActualNum=@ActualNum and Score=@Score and TID=@TID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@SID", SqlDbType.Int,4),
                    new SqlParameter("@SNo", SqlDbType.Char,9),
        ...
        public ITCastOCSS.Model.v_Teaching GetModel(int SID, string SNo, string SName, int CID, int Credit, string CName, string Week, string Timeperiod, string Place, int MaxNum, int ActualNum, decimal Score, int TID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 SID,SNo,SName,CID,Credit,CName,Week,Timeperiod,Place,MaxNum,ActualNum,Score,TID from v_Teaching ");
            strSql.Append(" where SID=@SID and SNo=@SNo and SName=@SName and CID=@CID and Credit=@Credit and CName=@CName and Week=@Week and Timeperiod=@Timeperiod and Place=@Place and MaxNum=@MaxNum and ActualNum=@ActualNum and Score=@Score and TID=@TID ");
            SqlParameter[] parameters = {
                    new SqlParameter("@SID", SqlDbType.Int,4),
                    new SqlParameter("@SNo", SqlDbType.Char,9),
            ...
            ITCastOCSS.Model.v_Teaching model = new ITCastOCSS.Model.v_Teaching();
        ...
        /// 得到一个对象实体
        /// </summary>
        public ITCastOCSS.Model.v_Teaching DataRowToModel(DataRow row)
        {
            ITCastOCSS.Model.v_Teaching model = new ITCastOCSS.Model.v_Teaching();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select SID,SNo,SName,CID,Credit,CName,Week,Timeperiod,Place,MaxNum,ActualNum,Score,TID ");
            strSql.Append(" FROM v_Teaching ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from v_Teaching T ");
